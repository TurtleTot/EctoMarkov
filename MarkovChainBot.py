...
class MarkovChain:
    ...
    def generate(self, params: List[str] = None) -> "Tuple[str, bool]":
        ...
        if len(params) > 1:
            ...
            if key == None:
                ...
                if key == None:
                    ...
                    return f"*squeak* I dont know much about \"{params[0]}\" yet. *squeak*", False
            ...
            if key:
                ...
                return "*Squeak*, I haven't learned enough from you yet.", False
        ...
        return "*Squeak* " + self.sent_separator.join(detokenize(sentence) for sentence in sentences), True
